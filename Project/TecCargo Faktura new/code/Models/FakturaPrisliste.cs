...
namespace TecCargo_Faktura.Models
{
    public class FakturaPrisliste
    {
        ...
        public static class EkstraGebyrPrice
        {
            public static double[][][] prices =
            {
                new double[][] { new double[] { 200, 200, 200, 200 }, new double[] {  200, 200, 200, 200 }},
                new double[][] { new double[] { 150, 150, 150, 150 }, new double[] {  150, 150, 150, 150 }},
                new double[][] { new double[] { 145, 165, 185, 205, 145 }, new double[] { 165, 185, 205 }},
                new double[][] { new double[] { 120, 130, 140, 150 }, new double[] {  120, 130, 140, 150 }},
                new double[][] { new double[] { 85, 105, 125, 145 }, new double[] {  85, 105, 125, 145 }},
                new double[][] { new double[] { 10, 10, 10, 10 }, new double[] {  10, 10, 10, 10 }},
                new double[][] { new double[] { 0, 0, 10, 10 }, new double[] {  0, 0, 10, 10 }},
                new double[][] { new double[] { 8, 8, 8, 8 }, new double[] {  8, 8, 8, 8 }},
                new double[][] { new double[] { 60, 60, 60, 60 }, new double[] {  60, 60, 60, 60 }}
            };
