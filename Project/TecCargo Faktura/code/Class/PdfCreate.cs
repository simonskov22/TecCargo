...
namespace TecCargo_Faktura.Class
{
    class PdfCreate
    {
        ...
        public class Faktura
        {
            ...
            /// <summary>
            /// opretter pdf data til CreateFaktura()
            /// 
            /// her bliver designet lavet
            /// </summary>
            ...
            /// <summary>
            /// givet hvis et tal .00 på
            /// ellers sender number tilbage
            /// </summary>
        ...
        public class FragtBrev
        {
            ...
            public void SaveFragtBrev(FragtBrevLayout InformationClass)
            {
                ...
                //lav 3 fragtbreve
                string[] footText = { "Afsenderens Kvittering", "Modtagerens Kvittering", "Chaufførens Kvittering" };//sidefod tekster
                doc.Open();
                for (int i = 0; i < 3; i++)
                {
                    doc.ResetPageCount();
            ...
            /// <summary>
            /// opret fragtbrev pdf design
            /// </summary>
            private PdfPTable CreatePDFTableOfFragtbrev(FragtBrevLayout InformationClass)
            {
                //hvad skrift type der skal bruge
                FragtText styleFont = new FragtText();
                PdfStyle stylePDF = new PdfStyle();
                //public Font UserInputMediumSmallText = new Font(Font.FontFamily.HELVETICA, 7.3f, Font.NORMAL, BaseColor.BLACK);
                
                //Brug fed skrift på det man skriver
                if (useBold()) styleFont.UserInputMediumSmallText.SetStyle(Font.BOLD);

                //Sæt farven til hvid hvis den skal være tom
                if (InformationClass.emptyPDF) styleFont.StregkodeTextInput.Color = BaseColor.WHITE;
                ...
                //stregkode billede
                Image stregKodeImage = Image.GetInstance(Directory.GetCurrentDirectory() + "/Images/Pdf/stregkodeOnlyKode.png");
            ...
            /// <summary>
            /// laver en cell hvor teksten står i midden
            /// </summary>
            ...
            /// <summary>
            /// laver en cell med en 
            /// checkbox og noget tekst
            /// </summary>
            private PdfPCell FastCellBox(string Text, bool GetCheck = false, float[] Padding = null, Font FontType = null)
            {
                FragtText styleFont = new FragtText();
                ...
                //opret table med checkbox og tekst
                ...
                //send tilbage en cell uden ramme
            ...
            /// <summary>
            /// laver en hurtig cell med noget tekst
            /// med flere indstilinger
            /// </summary>
            ...
            /// <summary>
            /// laver en hurtig cell med noget tekst som fed
            /// </summary>
            ...
            /// <summary>
            /// laver en table om til en cell med
            /// mulighed for at lave nogle indstilinger
            /// </summary>
            ...
            private bool useBold()
            {
                ...
                //hent værdi om der skal bruges fed skrift eller ej
                bool boolVal = false;
                bool.TryParse(readSettings.Tables["Settings"].Rows[0][0].ToString(), out boolVal);
