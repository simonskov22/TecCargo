...
$(document).ready(
    ...
    function () 
    {
        ...
        $('#beregn').click(function ()
        {
            ...
            $.post('//teccargo.dk/php/admin/php/price/beregnPrisPHP.php', {startPost:postStar,slutPost:postSlut,kilo:kg},function (visPris)
            {
        ...
        $('#user-table-box tr').click(function ()
        {
            ...
            else
            {
                ...
                $.post('//teccargo.dk/php/admin/php/users/editUserForm.php', {user:editUsername}, function (userForm)
                {
