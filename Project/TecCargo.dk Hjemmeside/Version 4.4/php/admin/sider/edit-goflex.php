...
unset($_SESSION['Kurer']);
    ...
    $sqlcmdGrp1 = "SELECT * FROM kurertransportPris WHERE id=5";
    $sqlcmdGrp2 = "SELECT * FROM kurertransportPris WHERE id=6";
    $sqlcmdGrp3 = "SELECT * FROM kurertransportPris WHERE id=7";
    $sqlcmdGrp4 = "SELECT * FROM kurertransportPris WHERE id=8";
...
$thisTheme = str_replace("%G1ID%", 5, $thisTheme);
$thisTheme = str_replace("%G2ID%", 6, $thisTheme);
$thisTheme = str_replace("%G3ID%", 7, $thisTheme);
$thisTheme = str_replace("%G4ID%", 8, $thisTheme);
$thisTheme = str_replace("%TYPE%", "GoFlex", $thisTheme);
