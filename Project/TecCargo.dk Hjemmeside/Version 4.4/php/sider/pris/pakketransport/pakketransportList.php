<?php
    ...
    if($type == "full")
    {
        $sqlcmd = "SELECT * FROM pakkkePrisList";
        $tableColspan = 5;
    }
    else
    {
    ...
    <body>
        <div class="pakketransportPris">
            <table>
                ...
                <tr>
                    <td colspan="3"><img src="../images/%PAKKEB8%" style="width: 600px; height: 150px; max-width: none; max-height: none;"></td>
